...
CMD java -jar -Dspring.profiles.active=${profile} chat-0.0.1-SNAPSHOT.jar --chat-db=${chat_db} --spring.rabbitmq.password=${rabbit_pass} --secretToken=${secret_token} --spring.datasource.passowrd=${db_pass}
